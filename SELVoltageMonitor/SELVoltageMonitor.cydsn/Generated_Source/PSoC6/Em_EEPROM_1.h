...
***************************************/
#define Em_EEPROM_1_STORAGE_EM_EEPROM          (0U != Em_EEPROM_1_USE_EMULATED_EEEPROM)
...
cy_en_em_eeprom_status_t Em_EEPROM_1_Init(uint32 startAddress);
...
*
*******************************************************************************/
#define Em_EEPROM_1_Write(addr, eepromData, size) \
                                            Cy_Em_EEPROM_Write(addr, eepromData, size, &Em_EEPROM_1_context)


/*******************************************************************************
* Function Name: Em_EEPROM_1_Read
****************************************************************************//**
*
...
*
*******************************************************************************/
#define Em_EEPROM_1_Read(addr, eepromData, size) \
                                            Cy_Em_EEPROM_Read(addr, eepromData, size, &Em_EEPROM_1_context)


/*******************************************************************************
* Function Name: Em_EEPROM_1_Erase
****************************************************************************//**
*
...
*
*******************************************************************************/
#define Em_EEPROM_1_Erase()                Cy_Em_EEPROM_Erase(&Em_EEPROM_1_context)


/*******************************************************************************
* Function Name: Em_EEPROM_1_NumWrites
****************************************************************************//**
*
...
*
*******************************************************************************/
#define Em_EEPROM_1_NumWrites()            Cy_Em_EEPROM_NumWrites(&Em_EEPROM_1_context)
...
#define Em_EEPROM_1_REDUNDANT_COPY             (0U)
